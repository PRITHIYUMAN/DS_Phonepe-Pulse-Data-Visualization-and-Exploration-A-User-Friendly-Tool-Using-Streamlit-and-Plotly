...
#conn = mysql.connector.connect(user='root', password='Arun@mysql9398', host='127.0.0.1', database="phonepe_pulse")
...
if SELECT == "Home":
    ...
    col1.image(Image.open("C:\\Users\\aasai\\OneDrive\\Desktop\\Phonepe_image2.png"),width = 300)
    with col1:
    ...
    with col2:
        st.video("C:\\Users\\aasai\\OneDrive\\Desktop\\upi.mp4")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r"C:\\Users\\aasai\\OneDrive\\Desktop\\Statenames.csv")
            df1.State = df2
...
if SELECT == "About":
    col1,col2 = st.columns(2)
    with col1:
        st.video("C:\\Users\\aasai\\OneDrive\\Desktop\\pulse-video.mp4")
    with col2:
        st.image(Image.open("C:\\Users\\aasai\\OneDrive\\Desktop\\Phonepe_image2.png"),width = 500)
        st.write("---")
    ...
    with col1:
        ...
        st.image(Image.open("C:\\Users\\aasai\\OneDrive\\Desktop\\about_phonepe.jpg"),width = 400)
        with open("C:\\Users\\aasai\\OneDrive\\Desktop\\about_phonepe1.png","rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT",data,file_name="annual report.pdf")
    with col2:
        st.image(Image.open("C:\\Users\\aasai\\OneDrive\\Desktop\\about_phonepe1.png"),width = 800)
...
if SELECT == "Contact":
    ...
    mail = (f'{"Mail :"}  {"aasaiprithi5@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        
        "GITHUB": "https://github.com/PRITHIYUMAN",
        "LINKEDIN": "https://www.linkedin.com/in/prithiyuman-a-646332273//"}

    col1, col2, col3 = st.columns(3)
    col3.image(Image.open("E:\personal\mark\prithiyuman.jpg"), width=300)
    st.subheader(Name)
    st.subheader(mail)
    with col2:
